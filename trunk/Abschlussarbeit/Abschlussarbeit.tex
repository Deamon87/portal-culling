\documentclass[12pt,twoside=semi]{scrreprt}
\parindent 0pt
\parskip 12pt
...
\begin{figure}[ht]
\centering
\includegraphics[width=325pt]{img/portalsplate1}
\caption{Test 1234}
\label{fig:portal1}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=300pt]{img/frustum_culling}
\caption{}
\label{fig:frustum}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=400pt]{img/projektor}
\caption{Beispiel für die Projektionsart im Holodeck. Das Holodeck benutzt das
Prinzip der zirkulären Polarisation}
\label{fig:proj}
\end{figure}
...
\begin{center}
    \includegraphics[width=\linewidth]{img/joglprofile}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=300pt]{img/spiegel_projektion}
\caption{}
\label{fig:mirror}
\end{figure}
...
Um zu verdeutlichen wie die einzelnen Wände transformiert werden müssen, werden
die verschiedenen Translationstransformationen noch einmal aufgeführt. Jede Wand
wird mit einem 3dimensionalen Vektor an die entsprechende Stelle transformiert.
Der Vektor $V$ wird über die Werte $x$, $y$ und $z$ definiert.
...
Dieses Kapitel soll nocheinmal die gemachten Ergebnisse zusammenfassen und
zeigen, inwiefern die gestellten Anforderungen erfüllt wurden.
...
Tür. Alle 3 unterscheiden sich voneinander und lassen sich nun innerhalb der
jVR-Umgebung nutzen.
...
\section{Weiterentwicklung der Portale}
