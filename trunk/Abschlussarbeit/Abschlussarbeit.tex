...
Das jVR-Framework ist im Rahmen einer Masterarbeit entstanden.Das Ziel des
Frameworks ist es den Studenten eine Plattform zu liefern mit denen sie komplexe
...
Das Framework entstand auf Basis der Programmiersprache Java. Diese bietet den
Vorteil sich nicht mit Sachen, wie Speichermanagement beschäftigen zu müssen,
sondern sich ganz auf die Funktionalität der zu erstellenden Anwendung zu
konzentrieren.

Für die 3D-Beschleunigung wird die Grafikbibliothek JOGL verwendet. Sie stellt 
eine Javaimplementierung der Grafikschnittstelle OpenGL dar. OpenGL ist ein
