...
% \caption{Die verschiedenen Profile, die von JOGL bereitgestellt
% werden.\protect\footnotemark}
% \label{fig:jogprof}
% \end{figure}
% \footnotetext{Quelle: }
...
und minimale Z-Wert der BB. Es reicht den maximalen Wert zu erhöhen um eine
